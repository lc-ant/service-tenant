...
public class TenantRestControllerV1 implements TenantService {
	...
	@Override
	@PostMapping("/_search")
	public Mono<PageResponse<Tenant>> search(@RequestBody Optional<Condition> criteria, PageRequest pageRequest) {
	...
	@Override
	@PostMapping("/{id}/configs/get")
	public Mono<Map<String, Serializable>> getConfigs(
		@PathVariable("id") String tenantId,
		@RequestBody List<String> requestedConfigurations) {
		return service.getConfigs(tenantId, requestedConfigurations);
	}
